...
def selection_sort(number_list):
    for_loops1 = 0
    for_loops2 = 0
    for cur_pos in range(len(number_list)):
        for_loops1 += 1
        min_pos = cur_pos
        for scan_pos in range(cur_pos + 1, len(number_list)):
            for_loops2 += 1
            if number_list[scan_pos] < number_list[min_pos]:
                min_pos = scan_pos
        number_list[cur_pos], number_list[min_pos] = number_list[min_pos], number_list[cur_pos]
    print(number_list)
    print(for_loops1)
    print(for_loops2)
